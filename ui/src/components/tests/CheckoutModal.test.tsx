...
it('Modal renders whether or not ShoppingCart is visible / cart is empty', () => {
    ...
    function Wrapper ({userId, screenVisible, order}: Props) {
        ...
        return <CheckoutModal userId={userId} cart={cart} setCart={setCart} setVisible={setVisible} />;
    }
